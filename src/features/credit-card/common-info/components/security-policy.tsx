...
const info2 = [
	...
	'(v) từ hoạt động phân tích Quý khách sử dụng và quản lý (các) tài khoản/ tiện ích của Quý khách tại nền tảng của chúng tôi (bao gồm trang web RUBY.tech và Ứng dụng RUBY), từ các giao dịch mà Quý khách thực hiện và từ khoản thanh toán được thực hiện từ/ đến (các) tài khoản/ tiện ích của Quý khách',
...
const info4 = [
	...
	't) để tiến hành nghiên cứu thị trường, khảo sát và phân tích dữ liệu liên quan đến bất kỳ sản phẩm hoặc dịch vụ nào do chúng tôi cung cấp (cho dù được tiến hành bởi riêng RUBY hoặc cùng với các bên khác) mà có thể liên quan tới Quý khách',
	...
	'v) để cung cấp thông tin, đề nghị giao dịch và tiến hành tiếp thị và khuyến mại tới Quý khách liên quan đến bất kỳ sản phẩm, dịch vụ, đề nghị giao dịch hoặc sự kiện nào do RUBY hoặc đối tác kinh doanh của RUBY cung cấp mà chúng tôi cho rằng Quý khách có thể quan tâm',
	'w) cho mục đích kiểm toán, quản lý rủi ro và tuân thủ',
	'x) để đáp ứng hoặc tuân thủ các chính sách nội bộ của RUBY và các thủ tục và bất kỳ quy tắc, luật pháp, quy định, quy tắc thực hành hoặc các hướng dẫn, chỉ thị hoặc yêu cầu được ban hành bởi bất kỳ tòa án, cơ quan pháp luật hoặc cơ quan quản lý nào (cả trong nước hoặc quốc tế) (bao gồm nhưng không giới hạn việc tiết lộ thông tin cho các cơ quan quản lý, thực hiện kiểm tra, giám sát hoặc điều tra kiểm toán)',
...
const info5 = [
	'(a) các công ty con và/hoặc các công ty liên kết của RUBY',
		...
		>
			<div className="flex flex-col gap-2 text-xs">
				<p>
					...
					“RUBY” hoặc “chúng tôi”) tôn trọng sự riêng tư và cố gắng bảo vệ dữ
				...
				<p>
					...
					dụng đối tác của RUBY, Điều khoản và Điều kiện Sử Dụng các nền tảng
					của RUBY (gọi chung là “Các Điều Khoản và Điều Kiện”) và nên được đọc
				...
				<div className="flex-2 flex flex-col gap-2">
					...
					<p>
						...
						hoặc được cho phép, với nhân viên, đại lý, bên tư vấn của RUBY Chúng
					...
					<p>
						...
						điều khoản bảo mật trong (các) thỏa thuận của Quý khách với RUBY.
					</p>
					<p className="mt-2 font-bold">
					...
					<p>
						3.2 Ngoài ra, các tổ chức riêng lẻ liên kết với RUBY, thương nhân và
					...
					<p>
						...
						các mục đích và tuỳ thuộc vào bản chất yêu cầu của Quý khách, RUBY
					...
					<p>
						...
						đồng ý nào mà Quý khách đã có với RUBY đối với việc sử dụng (các) số
					...
					<p>
						...
						cần thiết khác để đáp ứng lợi ích của RUBY và/ hoặc của khách hàng,
						hoặc khi pháp luật và/ hoặc các chính sách có liên quan của RUBY quy
					...
					<p>
						...
						web RUBY.tech và Ứng dụng RUBY.
					</p>
				</div>
			</div>
		</DialogWrapper>
